...
public class GlobalErrorHandler {
  ...
  public ResponseEntity<ErrorMessage> handleException(
      @NonNull BusinessException businessException) {
  ...
  public ResponseEntity<ErrorMessage> handleException(
    ...
    return ResponseEntity.badRequest()
        .body(new ErrorMessage(errors.getFirst().getDefaultMessage()));
  }
  ...
  public ResponseEntity<ErrorMessage> handleException(@NonNull Exception exception) {
    ...
    return ResponseEntity.internalServerError()
        .body(new ErrorMessage(GlobalMessages.DEFAULT_ERROR_MESSAGE));
  }
}
